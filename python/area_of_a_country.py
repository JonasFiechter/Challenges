...
Examples
area_of_country("Russia", 17098242) ➞ "Russia is 11.48% of the total world's 
landmass"

area_of_country("USA", 9372610), "USA is 6.29% of the total world's landmass"

area_of_country("Iran", 1648195) ➞ "Iran is 1.11% of the total world's 
landmass"
Notes
...
def area_of_country(country_name, area):
    return f"{country_name} is {round((area / 148940000) * 100, 2)}" \
           f"% of the total world's landmass"
